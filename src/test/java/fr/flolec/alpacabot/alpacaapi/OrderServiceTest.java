...
import fr.flolec.alpacabot.alpacaapi.order.OrderService;
import fr.flolec.alpacabot.alpacaapi.order.OrderSide;
import fr.flolec.alpacabot.alpacaapi.order.TimeInForce;
...
public class OrderServiceTest {
    ...
    @Test
    void getOrderById_nominal_orderRetrieved() throws AlpacaApiException {
    ...
    @Test
    void getOrderById_badIdError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.GET))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> orderService.getOrderById("azerty123456789"));
        assertEquals(HttpStatus.UNPROCESSABLE_ENTITY, alpacaApiException.getStatusCode());
        assertEquals(RESPONSE_ERROR_WRONG_ID, alpacaApiException.getAlpacaErrorMessage());
        assertEquals("Could not retrieve order of id 'azerty123456789'", alpacaApiException.getCustomMessage());
    }
