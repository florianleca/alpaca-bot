...
import fr.flolec.alpacabot.alpacaapi.accountdetails.AccountDetailsModel;
import fr.flolec.alpacabot.alpacaapi.accountdetails.AccountDetailsService;
...
class AccountDetailsServiceTest {
    ...
    @Test
    void getAccountDetails_nominal_accountDetailsRetrieved() throws AlpacaApiException {
    ...
    @Test
    void getAccountDetails_httpError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.GET))
                .andExpect(requestTo(uri))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> accountDetailsService.getAccountDetails());
        ...
        assertEquals("Account details could not be retrieved", alpacaApiException.getCustomMessage());
    }
