...
import fr.flolec.alpacabot.alpacaapi.position.PositionModel;
...
public class PositionServiceTest {
    ...
    @Test
    void getAnOpenPosition_nominal_positionSerialized() throws AlpacaApiException {
    ...
    @Test
    void getAnOpenPosition_symbolNotFound_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.GET))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.getAnOpenPosition("BTCd/USD"));
        assertEquals(HttpStatus.NOT_FOUND, alpacaApiException.getStatusCode());
        assertEquals(RESPONSE_GET_A_POSITION_ERROR_SYMBOL, alpacaApiException.getAlpacaErrorMessage());
        assertEquals("BTCd/USD position could not be retrieved", alpacaApiException.getCustomMessage());
    }

    @Test
    void getAnOpenPosition_positionDoesNotExist_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.GET))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.getAnOpenPosition("MKR/USD"));
        assertEquals(HttpStatus.NOT_FOUND, alpacaApiException.getStatusCode());
        assertEquals(RESPONSE_GET_A_POSITION_ERROR_NO_POSITION, alpacaApiException.getAlpacaErrorMessage());
        assertEquals("MKR/USD position could not be retrieved", alpacaApiException.getCustomMessage());
    }

    @Test
    void getAllOpenPositions_zeroOpenPosition_emptyListRetrieved() throws AlpacaApiException {
        mockRestServiceServer.expect(method(HttpMethod.GET))
    ...
    @Test
    void getAllOpenPositions_oneOpenPosition_oneElementRetrieved() throws AlpacaApiException {
        mockRestServiceServer.expect(method(HttpMethod.GET))
                .andExpect(requestTo(uri))
    ...
    @Test
    void getAllOpenPositions_threeOpenPositions_threeElementsRetrieved() throws AlpacaApiException {
        mockRestServiceServer.expect(method(HttpMethod.GET))
                .andExpect(requestTo(uri))
    ...
    @Test
    void getAllOpenPositions_httpError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.GET))
                .andExpect(requestTo(uri))
                .andRespond(withStatus(HttpStatus.FORBIDDEN).body("{error body}"));

        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.getAllOpenPositions());
        assertEquals(HttpStatus.FORBIDDEN, alpacaApiException.getStatusCode());
        assertEquals("{error body}", alpacaApiException.getAlpacaErrorMessage());
        assertEquals("All open positions could not be retrieved", alpacaApiException.getCustomMessage());
    }

    @Test
    void getCurrentQtyOfAsset_positionExists_quantityRetrieved() throws AlpacaApiException {
    ...
    @Test
    void getCurrentQtyOfAsset_noPosition_zeroQuantity() throws AlpacaApiException {
    ...
    @Test
    void getCurrentQtyOfAsset_nullQuantity_zeroQuantity() throws AlpacaApiException {
        PositionModel positionModel = new PositionModel();
        doReturn(positionModel).when(spiedPositionService).getAnOpenPosition("TEST");
        assertEquals(0, spiedPositionService.getCurrentQtyOfAsset("TEST"));
    }
    ...
    @Test
    void liquidatePositionByPercentage_nominal_sellOrderCreated() throws JsonProcessingException, AlpacaApiException {
    ...
    @Test
    void liquidatePositionByPercentage_httpError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(startsWith(uri + "/BTCUSD")))
                .andExpect(queryParam("percentage", "66.600000000"))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.liquidatePositionByPercentage("BTC/USD", 66.6));
        assertEquals(HttpStatus.UNPROCESSABLE_ENTITY, alpacaApiException.getStatusCode());
        assertEquals("{error body}", alpacaApiException.getAlpacaErrorMessage());
        assertEquals("BTC/USD position could not be liquidated by percentage", alpacaApiException.getCustomMessage());
    }

    @Test
    void liquidatePositionByQuantity_nominal_sellOrderCreated() throws JsonProcessingException, AlpacaApiException {
        OrderModel expectedOrderModel = new OrderModel();
        expectedOrderModel.setSymbol("BTC/USD");
        expectedOrderModel.setSide("sell");
        String jsonResponse = objectMapper.writeValueAsString(expectedOrderModel);
    ...
    @Test
    void liquidatePositionByQuantity_httpError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(startsWith(uri + "/BTCUSD")))
                .andExpect(queryParam("qty", "12.340000000"))
                .andRespond(withStatus(HttpStatus.UNPROCESSABLE_ENTITY)
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.liquidatePositionByQuantity("BTC/USD", 12.34));
        assertEquals(HttpStatus.UNPROCESSABLE_ENTITY, alpacaApiException.getStatusCode());
        assertEquals("{error body}", alpacaApiException.getAlpacaErrorMessage());
        assertEquals("BTC/USD position could not be liquidated by quantity", alpacaApiException.getCustomMessage());
    }

    @Test
    void liquidatePosition_nominal_sellOrderCreated() throws AlpacaApiException {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(uri + "/BTCUSD"))
    ...
    @Test
    void liquidatePosition_httpErrorAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(uri + "/BTCUSD"))
                .andRespond(withStatus(HttpStatus.UNPROCESSABLE_ENTITY)
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.liquidatePosition("BTC/USD"));
        assertEquals(HttpStatus.UNPROCESSABLE_ENTITY, alpacaApiException.getStatusCode());
        assertEquals(RESPONSE_DELETE_POSITION_ERROR, alpacaApiException.getAlpacaErrorMessage());
        assertEquals("BTC/USD position could not be liquidated", alpacaApiException.getCustomMessage());
    }

    @Test
    void liquidateAllPositions_zeroOpenPosition_zeroSellOrder() throws AlpacaApiException, JsonProcessingException {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
    ...
    @Test
    void liquidateAllPositions_oneOpenPosition_oneSellOrder() throws AlpacaApiException, JsonProcessingException {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(uri + "?cancel_orders=false"))
    ...
    @Test
    void liquidateAllPositions_threeOpenPositions_threeSellOrders() throws AlpacaApiException, JsonProcessingException {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(uri + "?cancel_orders=false"))
    ...
    @Test
    void liquidateAllPositions_httpError_throwAlpacaApiException() {
        mockRestServiceServer.expect(method(HttpMethod.DELETE))
                .andExpect(requestTo(uri + "?cancel_orders=false"))
        ...
        AlpacaApiException alpacaApiException = assertThrows(AlpacaApiException.class, () -> positionService.liquidateAllPositions(false));
        assertEquals(HttpStatus.BAD_REQUEST, alpacaApiException.getStatusCode());
        assertEquals(RESPONSE_DELETE_ALL_POSITIONS_ERROR, alpacaApiException.getAlpacaErrorMessage());
        assertEquals("All positions could not be liquidated", alpacaApiException.getCustomMessage());
    }
